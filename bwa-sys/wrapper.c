...
bseq1_t *new_bseq1_t(int id, const char *name, const char *seq, const char *qual) {
...
char* mem_align(const bwaidx_t* idx, const char *seq_name, const char *seq_seq, const char *seq_qual)
{
	...
	bseq1_t *seq = new_bseq1_t(0, seq_name, seq_seq, seq_qual);
